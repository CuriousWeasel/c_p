    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            <div class="col-md-9">
              <!-- Page Heading -->
              <h1 class="h3 mb-2 text-gray-800"><strong>Edit Country</strong><span style="ml-2 small"> <a href="locations.php" class="d-none d-sm-inline-block btn btn-sm shadow-sm">&laquo; Back</a></span></h1>
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-12 mb-3 brdr">
                    ...
                    <div class="col-md-6 mb-2"><input type="submit" value="Save" class="d-sm-inline-block btn btn-sm shadow-sm"></div><div class="col-md-6 mb-2"><a href="delcountry.php?country_id=<?=$country_id;?>" class="d-sm-inline-block btn btn-sm shadow-sm">Delete</a></div>
            ...
            <div class="col-md-12 mb-2"><strong>Images</strong></div>
                            ...
                            <div class="col-md-4 mb-3"><strong>Gallery Images</strong> <br>
                              <?php $countryimages = getFields('tbl_country_gallery','country_id',$country_id);  $countryimagesIDs = ''?>
                              <div class="col-md-12 mb-3 countrygallery">
                                <?php for($ci=0;$ci<count($countryimages);$ci++){
                                    echo ('<div class="col-md-4 mb-1"><a href="delcountryimage.php?id='.$countryimages[$ci]['id'].'"><img src="'.$countryimages[$ci]['image_loc_low'].'" alt="'.$countryimages[$ci]['image_alt'].'" style="width:90%;"/></a></div>');
                                }
                                ?>
                                </div>    
...
var uploader2 = new plupload.Uploader({
	...
	url : 'upload.php?tbl=tbl_countrygallery',
	flash_swf_url : 'js/plupload/Moxie.swf',
	silverlight_xap_url : '.js/plupload/Moxie.xap',
	unique_names : true,
	filters : {
